...
for root, _dirs, files in os.walk(inat_jpg_path):
    for file in files:
        if file.lower().endswith(".jpg"):
            ...
            csv_filename_simon = "/home/edouard/Bureau/tests_qfieldcloud/data/formatted_csv/jbuf/simon_rerat_EPSG:4326.csv"

            csv_filename_jade = "/home/edouard/Bureau/tests_qfieldcloud/data/formatted_csv/jbuf/jade_dandois_EPSG:4326.csv"
